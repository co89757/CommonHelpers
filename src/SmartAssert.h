...
namespace colinli
{
	namespace utility
	{
		...
		/// <summary>
		/// class that encapsulates all context information such as expression that triggers the assertion failure,
		...
		public:
			...
			template<typename T>
			void addValue(T val, const std::string& varRepr)
			{
			...
			std::stringstream& getVariableReprStream()
			{
				return variableRepr;
			}
